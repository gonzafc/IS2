...
#* chain of command / chain of responsibility
...
class HandlerLetraa(AbstractHandler):
...
class User:
    ...
    def __init__(self):
        ...
        self.handler = HandlerLetraa(FirstConcreteHandler(SecondConcreteHandler(ThirdConcreteHandler(DefaultHandler(initial)))))
